"""
Django settings for CampusLove project.
...
SECRET_KEY = 'bv8%+481uc(d5qkz59kx3q&^ap4h&wiz^d=2ctohm*5!and)fs'
...
WSGI_APPLICATION = 'CampusLove.wsgi.application'
